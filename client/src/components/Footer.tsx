    ...
    <footer style={{ backgroundColor: "#080E1E", padding: "3.25rem 0 1.75rem" }}>
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2.5rem", marginBottom: "2.5rem" }}>
          {/* Brand */}
          <div>
            <img src={IMGS.logo} alt="Throttl" style={{ height: "30px", width: "auto", filter: "brightness(0) invert(1)", marginBottom: "1rem", opacity: 0.9 }} />
          ...
          {/* Services */}
          <div>
            <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "1rem" }}>Services</div>
            {[
          ...
          {/* Company */}
          <div>
            <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "1rem" }}>Company</div>
          ...
          {/* CTA */}
          <div>
            <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "1rem" }}>Get Started</div>
            ...
            <a href={BOOKING_URL} style={{
              ...
              fontWeight: 700, textDecoration: "none", letterSpacing: "0.04em", textTransform: "uppercase",
