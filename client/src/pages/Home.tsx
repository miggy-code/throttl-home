            ...
            {USE_CASES.map((uc, i) => {
              ...
              return (
                <div key={i} style={{
                  ...
                  boxShadow: `0 4px 20px ${C.navy}08`,
                  ...
                  onMouseEnter={e => {
                    ...
                    el.style.boxShadow = `0 12px 32px ${C.navy}12`;
                    el.style.transform = "translateY(-5px)";
                    el.style.borderColor = `${C.coral}30`;
                  }}
                  onMouseLeave={e => {
                    const el = e.currentTarget as HTMLDivElement;
                    el.style.boxShadow = `0 4px 20px ${C.navy}08`;
                    el.style.transform = "translateY(0)";
                    el.style.borderColor = `${C.navy}0D`;
                  }}
                >
                  <div style={{ width: "36px", height: "36px", borderRadius: "6px", backgroundColor: `${C.coral}15`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "0.9rem" }}>
