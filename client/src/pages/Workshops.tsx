    ...
    <div style={{ backgroundColor: C.cream, color: C.navy, fontFamily: "'Outfit', sans-serif" }}>
      ...
      <section style={{ padding: "5rem 0", backgroundColor: C.cream }}>
        <div className="container">
          ...
          <div ref={topics.ref} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "0.75rem" }}>
            {TOPICS.map((t, i) => (
              <div key={i} style={{
                ...
                <span style={{ fontSize: "0.875rem", color: C.navy, lineHeight: 1.5 }}>{t}</span>
              </div>
            ))}
          </div>
        </div>
