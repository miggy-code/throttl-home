...
const SERVICES = [
  { label: "AI Workshops",             href: "/workshops",     desc: "Hands-on AI training & certification for executives" },
  { label: "AI Business Transformation", href: "/transformation", desc: "In-house enablement using the Throttl Accelerator" },
];
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
          ...
          >
            <button onClick={() => setServicesOpen(v => !v)} style={{
              ...
              transition: "opacity 0.2s, color 0.35s", letterSpacing: "0.01em",
            }}>
              Services
              <ChevronDown size={14} style={{ transition: "transform 0.25s ease", transform: servicesOpen ? "rotate(180deg)" : "rotate(0deg)" }} />
            </button>
