      ...
      <section style={{ padding: "5rem 0", backgroundColor: C.creamDark }}>
        <div className="container">
          ...
          <FadeSection delay={0.1}>
            <div style={{ display: "flex", alignItems: "center", marginBottom: "2.75rem" }}>
              {ACCELERATOR_STEPS.map((s, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", flex: i === ACCELERATOR_STEPS.length - 1 ? "0 0 auto" : 1 }}>
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minWidth: "64px" }}>
                    ...
                    <div style={{ fontWeight: 700, color: C.navy, fontSize: "0.8rem", textAlign: "center", letterSpacing: "-0.02em" }}>{s.label}</div>
                  </div>
                ...
                {i % 2 === 0 && (
                  <div style={{ position: "relative", padding: "3rem 2.5rem", display: "flex", flexDirection: "column", justifyContent: "center", overflow: "hidden" }}>
                    ...
                    <div style={{ position: "relative", zIndex: 1 }}>
                      <div style={{ fontSize: "5rem", fontWeight: 700, color: "rgba(255,255,255,0.15)", lineHeight: 1, marginBottom: "0.5rem", transition: "color 0.3s ease" }}
