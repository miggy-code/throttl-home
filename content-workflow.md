...
- [ ] Humanizer pass completed before critic review and final packaging
- [ ] Formatting agent pass completed
- [ ] Hero is a real editorial image or validated intentional asset, not a dense text diagram
- [ ] Hero path verified against `public/` and rendered locally
- [ ] Reusable visual components used where appropriate
...
- [x] Preview rendered and links checked locally
- [ ] Desktop and mobile visual QA reviewed by human
